...
// working directiry must be ./circuits
process.chdir("./previous-implementation");
...
// groth16, prints the average time taken to run each phase (10 runs)

averageTimes('homAddMult10',   'homAddMult10-input',   'powersOfTau28_hez_final_08', 'groth16', 10);
averageTimes('homAddMult100',  'homAddMult100-input',  'powersOfTau28_hez_final_11', 'groth16', 10);
averageTimes('homAddMult1000', 'homAddMult1000-input', 'powersOfTau28_hez_final_14', 'groth16', 10);

averageTimes('homEncMult10',  'homEncMult10-input',  'powersOfTau28_hez_final_16', 'groth16', 10);
averageTimes('homEncMult20',  'homEncMult20-input',  'powersOfTau28_hez_final_17', 'groth16', 10);
averageTimes('homEncMult30',  'homEncMult30-input',  'powersOfTau28_hez_final_17', 'groth16', 10);
averageTimes('homEncMult40',  'homEncMult40-input',  'powersOfTau28_hez_final_18', 'groth16', 10);
...
averageTimes('homEncMult70',  'homEncMult70-input',  'powersOfTau28_hez_final_19', 'groth16', 10);
averageTimes('homEncMult80',  'homEncMult80-input',  'powersOfTau28_hez_final_19', 'groth16', 10);
...
averageTimes('re-RandMult50',  're-RandMult50-input',  'powersOfTau28_hez_final_18', 'groth16', 10);
...
averageTimes('re-RandMult90',  're-RandMult90-input',  'powersOfTau28_hez_final_19', 'groth16', 10);
averageTimes('re-RandMult100', 're-RandMult100-input', 'powersOfTau28_hez_final_19', 'groth16', 10);